...
export const aboutStats = [
  ...
  { value: "48hs", label: "entrega garantizada", color: "" },
] as const;
...
export const testimonials: Testimonial[] = [
  {
    stars: "★★★★★",
    quote:
      'En 48h tenía exactamente <strong class="text-green font-semibold">7 cosas concretas</strong> que arreglar en mi e-commerce. La primera —cambiar el copy del botón de checkout— me subió la conversión un 11% en una semana.',
    result: "▲ +11% conversión · semana 1",
    initials: "MR",
    avatarStyle:
      "background: linear-gradient(135deg, #2e5bff, #0e1f5c); color: #ffffff;",
    name: "Marta Ruiz",
  ...
  },
  {
    stars: "★★★★★",
    quote:
      'Llevaba meses tirando dinero en Meta Ads sin entender por qué. El análisis del pilar 4 me destapó <strong class="text-green font-semibold">3 ángulos quemados</strong> en mis anuncios y dos hooks nuevos. CPA bajó un 34%.',
    result: "▼ −34% CPA en Meta",
    initials: "JM",
    avatarStyle:
      "background: linear-gradient(135deg, #a3ff12, #6db300); color: #050505;",
    name: "Javier Mendoza",
  ...
  },
  {
    stars: "★★★★★",
    quote:
      'Mi anterior agencia me pasó un PDF de 80 páginas que no leí jamás. AuditaDigital me devolvió <strong class="text-green font-semibold">una hoja con 12 acciones priorizadas por $ de impacto.</strong> Por fin sé qué hacer el lunes.',
    result: "▲ Roadmap ejecutable · 12 acciones",
    initials: "DC",
    avatarStyle:
      "background: linear-gradient(135deg, #ff5c00, #b34000); color: #ffffff;",
    name: "Daniel Cortés",
...
export const pains: Pain[] = [
  ...
  },
  {
    ...
    stat: "54% lo dice",
    quote:
      "Mi agencia me pasa reportes imposibles de leer. No sé qué tengo que hacer el lunes.",
